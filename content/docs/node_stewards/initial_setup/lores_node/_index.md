...
{{<todo>}}
Layout a plan for using abra to install LoRes Node, building upon the processes developed in the last section. Include initial use of LoRes Node to setup or join a region, and register the kiwix app.
{{</todo>}}
