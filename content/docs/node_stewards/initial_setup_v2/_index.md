...
menus:
  docs:
    name: Initial setup v2
    parent: Node Stewards
---

{{<under-construction>}}
This section is under construction. Please see [Initial setup](/docs/node_stewards/initial_setup) for the current recommended approach. This alternate approach to setup aims to make things easier, but is incomplete. Follow along only if you're keen to help smooth out the bumps.
{{</under-construction>}}
